            ...
            if ($activity_types) {
                foreach ($activity_types as $activity_type) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo "$CFG->wwwroot/blocks/cpd_block/metadata.php?edit=activitytype&id=$activity_type->id" ?>">
                                <img src="<?php echo $OUTPUT->pix_url('/t/edit') ?>" alt="edit" />
                            </a>
                            <a onclick="return confirm('Are you sure you want to delete?');" 
                               href="<?php echo "$CFG->wwwroot/blocks/cpd_block/metadata.php?delete=activitytype&id=$activity_type->id" ?>">
                                <img src="<?php echo $OUTPUT->pix_url('/t/delete') ?>" alt="delete" />
                            </a>
                        </td>
                    </tr>
                    <?php
            ...
            if ($years) {
                foreach ($years as $year) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo "$CFG->wwwroot/blocks/cpd_block/metadata.php?edit=year&id=$year->id" ?>">
                                <img src="<?php echo $OUTPUT->pix_url('/t/edit') ?>" alt="edit" />
                            </a>
                            <a onclick="return confirm('Are you sure you want to delete?');"
                               href="<?php echo "$CFG->wwwroot/blocks/cpd_block/metadata.php?delete=year&id=$year->id" ?>">
                                <img src="<?php echo $OUTPUT->pix_url('/t/delete') ?>" alt="delete" />
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo "$CFG->wwwroot/blocks/cpd_block/metadata.php?moveup=status&id=$status->id" ?>">
                                <img src="<?php echo $OUTPUT->pix_url('/t/up') ?>" alt="up" />
                            </a>
                            <a href="<?php echo "$CFG->wwwroot/blocks/cpd_block/metadata.php?movedown=status&id=$status->id" ?>">
                                <img src="<?php echo $OUTPUT->pix_url('/t/down') ?>" alt="down" />
                            </a>
                            <?php
                            if (!in_array(strtoupper($status->name), array('OBJECTIVE MET'))) {
                                ...
                                <a onclick="return confirm('Are you sure you want to delete?');"
                                   href="<?php echo "$CFG->wwwroot/blocks/cpd_block/metadata.php?delete=status&id=$status->id" ?>">
                                    <img src="<?php echo $OUTPUT->pix_url('/t/delete') ?>" alt="delete" />
                                </a>
                                <?php
                            }
